...
import Game2Canvas from "./Game2Canvas";
import * as Auth0 from "auth0-web";
import io from "socket.io-client";

Auth0.configure({
  domain: "caioborges.auth0.com",
  clientID: "AoO5DzxipolxdQZ43cqzx6izv5UQ9ci9",
...
class Game2App extends Component {
  constructor(props) {
    super(props);
